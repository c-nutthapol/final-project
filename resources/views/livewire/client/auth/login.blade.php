<form wire:submit.prevent="submit">
    ...
    <div class="mb-5">
        ...
        <div class="relative">
            ...
            <input type="text" id="email" wire:model.defer="usernameOrEmail"
    ...
    <button type="submit"
        ...
        <span class="btn-text" wire:target="submit" wire:loading.class="hidden">เข้าสู่ระบบ</span>
    </button>
</form>
