...
<div class="col-span-9">
    <div class="p-10 bg-white rounded-2xl shadow-card-course font-ibm">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <button type="button" class="flex items-center btn is-primary" data-modal-toggle="create-requirement-modal">
        ...
        <!--------- Pagination   ---------->
        {{ $mustHave->links('pagination.livewire.main') }}
    </div>
</div>
@push('script')
    <script>
