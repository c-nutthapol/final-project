...
@section('teacher.content')
                ...
                <div class="p-10 bg-white rounded-2xl shadow-card-course font-ibm">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <button type="button" class="flex items-center btn is-primary"
                            data-modal-toggle="create-requirement-modal">
                            <i class="leading-none fi fi-rr-plus"></i>
                            <span class="inline-block ml-2">เพิ่มสิ่งที่ผู้เรียนต้องมี</span>
                        </button>
                    </div>
                    <!--------- Search ---------->
    ...
    <div id="edit-requirement-modal" data-modal-backdrop="static" tabindex="-2" aria-hidden="true"
            ...
            <div class="relative bg-white shadow rounded-2xl">
                ...
                <div class="flex items-center justify-between p-4 border-b rounded-t">
                    <h3 class="flex items-center space-x-2 text-xl font-semibold text-secondary">
                        <i class="leading-none fi fi-rr-edit"></i>
                        <span>แก้ไขสิ่งที่ผู้เรียนต้องมี</span>
                    </h3>
                    <button type="button"
                ...
                <form>
                        ...
                        <div class="grid grid-cols-2 gap-x-3 gap-y-4">
                            <div class="col-span-2">
                                ...
                                <input type="text" id="requirement"
                                    ...
                                    placeholder="สิ่งที่ผู้เรียนต้องมี" />
                            </div>
                        </div>
                    </div>
                    <!-- Modal footer -->
                    <div class="flex items-center justify-end p-6 space-x-2 border-t border-gray-200 rounded-b">
                        ...
                        <button data-modal-toggle="edit-requirement-modal" type="submit" class="btn is-warning">
                            <div class="flex items-center">
    ...
    <div id="create-requirement-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
        class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
        <div class="relative w-full h-full max-w-2xl md:h-auto font-ibm">
            <!-- Modal content -->
            <div class="relative bg-white shadow rounded-2xl">
                ...
                <div class="flex items-center justify-between p-4 border-b rounded-t">
                    <h3 class="flex items-center space-x-2 text-xl font-semibold text-secondary">
                        <i class="leading-none fi fi-rr-plus"></i>
                        <span>เพิ่มสิ่งที่ผู้เรียนต้องมี</span>
                    </h3>
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                        data-modal-toggle="create-requirement-modal">
                ...
                <form>
                    ...
                    <div class="flex items-center justify-end p-6 space-x-2 border-t border-gray-200 rounded-b">
                        ...
                        <button data-modal-toggle="create-requirement-modal" type="submit" class="btn is-primary">
                            <div class="flex items-center">
