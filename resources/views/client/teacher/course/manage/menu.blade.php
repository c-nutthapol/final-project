              <aside class="sticky left-0 space-y-8 top-24">
                  <ul class="flex flex-col flex-wrap text-base font-medium font-ibm">
                      ...
                      <li>
                          <a href="{{ route('client.teacher.course.manage.requirements', $id) }}"
