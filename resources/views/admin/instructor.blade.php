...
<div x-data="getData()">
    ...
    <!-- Status Modal -->
    <div id="statusModal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full" wire:ignore.self>
                ...
                <form @submit.prevent="updateInstructor">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <figure class="flex flex-col items-center space-y-4">
                            <img :src="avatar" alt="avatar" class="object-cover object-top w-20 h-20 rounded-full" />
                        ...
                        <div>
                            ...
                            <p class="text-base font-semibold text-secondary" id="target_audience" x-text="target_audience"></p>
                        </div>
                        <div>
                            ...
                            <textarea class="block w-full px-3 py-2 text-base font-normal bg-transparent border rounded-md border-secondary-80 text-secondary placeholder:text-secondary-80 placeholder:font-light focus:ring-primary focus:border-ring-primary" id="description" rows="5" x-model="formData.description"></textarea>
                        </div>
                        <div>
                            <label for="status" class="block mb-1.5 text-base font-medium text-dark-theme">
                                สถานะ
                            </label>
                            <select id="status" class="block w-full px-3 py-2 text-base font-normal bg-transparent border rounded-md border-secondary-80 text-secondary placeholder:text-secondary-80 placeholder:font-light focus:ring-primary focus:border-ring-primary" x-model="formData.status">
