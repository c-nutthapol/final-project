            ...
            <div class="relative overflow-x-auto">
                <table class="w-full text-sm text-left text-secondary">
                    <thead class="text-sm uppercase text-secondary/60 bg-primary/5">
                        <tr>
                            <th scope="col" class="px-6 py-3">ชื่อคอร์ส</th>
                            <th scope="col" class="px-6 py-3">เวลา</th>
                            <th scope="col" class="px-6 py-3">สถานะ</th>
                            <th scope="col" class="px-6 py-3">ตรวจสอบคอร์ส</th>
                            <th scope="col" class="px-6 py-3">ตัวเลือก</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="w-2/5 px-6 py-4 space-x-3 break-all">
                                <!--------- Photo ---------->
                                <figure class="flex items-center space-x-3">
                                    <img src="https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                                        alt="Photo" class="object-cover object-center w-40 h-24 rounded-xl" />
                                    <figcaption class="text-base font-semibold leading-normal text-secondary line-clamp-2">
                                        Angular - The Complete Guide (2022 Edititon) Angular
                                        - The Complete Guide (2022 Edititon)
                                    </figcaption>
                                </figure>
                            </td>
                            <td class="px-6 py-4">
                    ...
                    <form>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <figure class="flex flex-col items-center space-y-4">
                                <div class="h-40">
                                    <img src="https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                                        alt="avatar" class="object-contain w-full h-full rounded-xl" />
                                </div>
                                <figcaption class="text-base font-semibold text-secondary line-clamp-1">
                                    Angular - The Complete Guide (2022 Edititon) Angular Angular -
                                    The Complete Guide (2022 Edititon) Angular
                                </figcaption>
                            </figure>
                            <div>
