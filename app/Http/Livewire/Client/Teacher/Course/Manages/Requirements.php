...
class Requirements extends Component
{
    ...
    public function render()
    {
        ...
        $mustHave = $this->paginate($course->must_have, $this->search);
        return view('livewire.client.teacher.course.manages.requirements', compact('mustHave'));
    }
